	...
	<div class="wrapper">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{ asset('storage/' . ($user->picture ?? 'profile_photos/default.jpg')) }}" class="avatar img-fluid rounded me-1" alt="{{ $user_info->name }}" /> <br> <br><span class="text-dark">{{ $user_info->name }}</span>
              </a>
